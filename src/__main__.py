...
from .common import setup_paths, FAISS_DIR, MAPPING_DIR
...
faiss_path = FAISS_DIR / f"faiss_index_{extractor_name}.faiss"
mapping_path = MAPPING_DIR / f"mapping_{extractor_name}.json"
...
query =[
    "A Petrolimex fuel tanker truck.",
    # "In the background, green trees and a yellow wall frame the outdoor fueling station scene."
    ]

print(searcher.search(query, top_k=10, use_rrf=True))
